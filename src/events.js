...
export const eventLibrary = {
  skylounge: [
    ...
    { artist: "{Infos}", title: "{Infos}", date: "06.06.26", past: true, location: "Skylounge", category: "Live Music", hasTicket: false, ticketUrl: "",               image: _IMGS[6], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
    { artist: "{Infos}", title: "{Infos}", date: "20.06.26", past: true, location: "Skylounge", category: "Club Night", hasTicket: true,  ticketUrl: "/anfrage.html", image: _IMGS[7], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
    { artist: "{Infos}", title: "{Infos}", date: "04.07.26", past: true, location: "Skylounge", category: "Club Night", hasTicket: false, ticketUrl: "",               image: _IMGS[8], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
    { artist: "{Infos}", title: "{Infos}", date: "18.07.26", past: true, location: "Skylounge", category: "Live Music", hasTicket: false, ticketUrl: "",               image: _IMGS[9], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
  ...
  deck1: [
    ...
    { artist: "{Infos}", title: "{Infos}", date: "30.05.26", past: true, location: "Deck1", category: "Club Night", hasTicket: true,  ticketUrl: "/anfrage.html", image: _IMGS[1], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
    { artist: "{Infos}", title: "{Infos}", date: "13.06.26", past: true, location: "Deck1", category: "Club Night", hasTicket: false, ticketUrl: "",               image: _IMGS[2], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
    { artist: "{Infos}", title: "{Infos}", date: "27.06.26", past: true, location: "Deck1", category: "Club Night", hasTicket: true,  ticketUrl: "/anfrage.html", image: _IMGS[3], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
    { artist: "{Infos}", title: "{Infos}", date: "11.07.26", past: true, location: "Deck1", category: "Club Night", hasTicket: false, ticketUrl: "",               image: _IMGS[4], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
    { artist: "{Infos}", title: "{Infos}", date: "25.07.26", past: true, location: "Deck1", category: "Club Night", hasTicket: false, ticketUrl: "",               image: _IMGS[5], desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." },
